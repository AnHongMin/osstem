...
public class DateUtil {
	...
	public static String getCurYmd(String tz_id) throws Exception{
		if(StringUtils.trimToEmpty(tz_id).equals("")) tz_id = "Asia/Seoul";
	...
	/**
	 * 날짜 변환
	 * ymd 12 June. 2012 (TUE) -> 20120712
	 * 20120712 -> ymd 12 June. 2012 (TUE) 
	 * @param ymd 12 June. 2012 (TUE)
	 * @return 
	 */
