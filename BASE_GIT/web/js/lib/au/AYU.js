...
ayu.str.getVal = function( obj, xss ) {
  ...
  if( xss == true ) result = ayu.str.clearXss( result ); 
...
ayu.str.replace= function( string, pattern, wannaBeString ) {
  if( ayu.chk.isNull(string) ) return "";
  if( ayu.chk.isNull(pattern) ) return string;
  return ayu.str.getVal(string).replace( pattern, ayu.str.getVal(wannaBeString) ); 
}
...
ayu.str.lpad = function( string, length, fillChar ) {
  ...
  if( ayu.chk.isEmpty(string) ) return "";
...
ayu.str.parseNum= function( string ) {
  if( ayu.chk.isNull(string) ) return 0;
...
ayu.str.getMoney= function( string ) {
  if( ayu.chk.isEmpty(string) ) return string;
...
ayu.str.hasValue = function( string, pattern ) {
  return ( ayu.str.getVal(string).indexOf(ayu.str.getVal(pattern)) >= 0 ) ? true : false;                                         
}
...
ayu.chk.isReg = function( string, pattern ) {
  if( ayu.chk.isEmpty(string) || ayu.chk.isNull(pattern) ) return false;
...
ayu.chk.isRegEmpty = function( string, pattern ) {
  if( ayu.chk.isEmpty(string) ) return true;
  if( ayu.chk.isNull(pattern) ) return false;
  return pattern.test( ayu.str.getVal(string) );
}
...
ayu.chk.isReg2 = function( string, pattern1, pattern2, pattern3 ) {
  if( ayu.chk.isEmpty(string) || ayu.chk.isNull(pattern1) || ayu.chk.isNull(pattern2) || ayu.chk.isNull(pattern3) ) return false;
  return pattern1.test( ayu.str.getVal(string) ) && pattern2.test( ayu.str.getVal(string) ) && pattern3.test( ayu.str.getVal(string) );
}
...
ayu.chk.isArr = function( obj ) {
  if( ayu.chk.isNull(obj) ) return false;
...
ayu.chk.isUEngNum = function( obj ) {
  return ayu.chk.isReg2( obj, ayu.str._regPtn.IS_NUM_UENG, ayu.str._regPtn.UENG, ayu.str._regPtn.NUM );
}
...
ayu.chk.isUEngNumOrNum = function( obj ) {
  return ayu.chk.isReg2( obj, ayu.str._regPtn.IS_NUM_UENG, ayu.str._regPtn.UENG, ayu.str._regPtn.NUM ) || ayu.chk.isReg( obj, ayu.str._regPtn.IS_NUM );
}
...
ayu.chk.isRrn = function( obj ) {
  ...
  // 형식 체크
  if( ! ayu.chk.isReg(obj, ayu.str._regPtn.IS_RRN) ) return false;
...
ayu.chk.isFgn = function( obj ) {
  ...
  // 형식 체크
  if( ! ayu.chk.isReg(obj, ayu.str._regPtn.IS_FGN) ) return false;
  var _rrn = ayu.str.getNum( obj );
...
ayu.chk.isBun = function( obj ) {
  ...
  if( !ayu.chk.isReg(_bun, ayu.str._regPtn.IS_NUM) || !ayu.chk.isReg(_bun, /^\d{10}$/)) 
    return false;
...
ayu.chk.isBubin = function( obj ) {
  ...
  if( !ayu.chk.isReg(_bin, ayu.str._regPtn.IS_NUM) || !ayu.chk.isReg(_bin, /^\d{13}$/)) 
    return false;
...
ayu.chk.isNumAndEng = function( obj ) {
  ...
  if(ayu.chk.isReg( obj, ayu.str._regPtn.IS_NUM_ENG ))
    return (!ayu.chk.isReg( obj, ayu.str._regPtn.IS_NUM ) && !ayu.chk.isReg( obj, ayu.str._regPtn.IS_ENG))
  else
    return false;
